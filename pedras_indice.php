...
<div id="allcontent"> <!-- ALLCONTENT -->
	...
	<h2><a href="catalogo.php" title="Ir para Catálogo">Catálogo</a> | Pedras</h2>
    
    <section class="catalogo_indice">
    
    	<div class="catalogo_indice_titulo">
        <h6><a href="pedras_marmore.php" title="">Mármores</a></h6>
        </div>
        
        <div class="catalogo_indice_titulo">
        <h6><a href="pedras_granitos.php" title="">Granitos</a></h6>
        </div>
        
        <div class="catalogo_indice_titulo">
        <h6><a href="pedras_travertinos.php" title="">Travertinos</a></h6>
        </div>
        
        <div class="catalogo_indice_titulo">
        <h6><a href="pedras_marmoglass.php" title="">Marmoglass</a></h6>
        </div>
        
        <div class="catalogo_indice_titulo">
        <h6><a href="pedras_quartz-stone.php" title="">Quartz-Stone</a></h6>
        </div>
