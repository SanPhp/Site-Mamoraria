...
<div id="allcontent"> <!-- ALLCONTENT -->
	...
	<h2><a href="catalogo.php" title="Ir para Catálogo">Catálogo</a> | <a href="pedras_indice.php">Pedras</a> | Quartz-Stone</h2>
    
    	<section class="pedras">
        
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/bege_fendi.jpg" alt="Pedras">
            <figcaption><span>Bege Fendi</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/bege_sabbia.jpg" alt="Pedras">
            <figcaption><span>Bege Sabbia</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/branco_absoluto.jpg" alt="Pedras">
            <figcaption><span>Branco Absoluto</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/branco_matte.jpg" alt="Pedras">
            <figcaption><span>Branco Matte</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/branco_stellar.jpg" alt="Pedras">
            <figcaption><span>Branco Stellar</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/marrom_taupe.jpg" alt="Pedras">
            <figcaption><span>Marrom Taupe</span></figcaption>
            </figure>
            
            <figure class="pedras_lista">
            <img src="estru/pedras/quartz-stone/preto_stellar.jpg" alt="Pedras">
            <figcaption><span>Preto Stellar</span></figcaption>
            </figure>
